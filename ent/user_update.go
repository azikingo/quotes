...
func (uu *UserUpdate) SetTgID(i int64) *UserUpdate {
...
func (uu *UserUpdate) SetNillableTgID(i *int64) *UserUpdate {
	if i != nil {
		uu.SetTgID(*i)
	}
	return uu
...
func (uu *UserUpdate) AddTgID(i int64) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.AddedTgID(); ok {
		_spec.AddField(user.FieldTgID, field.TypeInt64, value)
	}
...
// SetTgID sets the "tg_id" field.
func (uuo *UserUpdateOne) SetTgID(i int64) *UserUpdateOne {
...
// SetNillableTgID sets the "tg_id" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableTgID(i *int64) *UserUpdateOne {
	if i != nil {
		uuo.SetTgID(*i)
	}
	return uuo
...
// AddTgID adds i to the "tg_id" field.
func (uuo *UserUpdateOne) AddTgID(i int64) *UserUpdateOne {
