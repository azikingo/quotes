...
func (c *QuoteClient) UpdateOneID(id int64) *QuoteUpdateOne {
...
func (c *QuoteClient) DeleteOneID(id int64) *QuoteDeleteOne {
...
func (c *QuoteClient) Get(ctx context.Context, id int64) (*Quote, error) {
	return c.Query().Where(quote.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *QuoteClient) GetX(ctx context.Context, id int64) *Quote {
